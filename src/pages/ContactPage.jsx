...
import prem from "../assets/rushi.jpg"
import prnzzz from "../assets/prnzzz.jpg"
  ...
  return (
    <section className="contact-section container">
      ...
      <div className="row">
        ...
        <div className="col-md-4 mb-4 p-2">
          <div className="card contact-card mt-2">
            <img src={ck} alt="Chaitanya Khade" className="profile-img" />
            <div className="card-header">Chaitanya Khade</div>
            <div className="card-body">
              <p className="card-text">Phone: +91 9404440080</p>
            </div>
          </div>
        </div>
      </div>
