...
const UpdateCompanyForm = ({ existingData }) => {
    ...
    const handleConfirm = () => {
        console.log('Updated Company:', formData);
        // Here you can add your code to send updated formData to your server
        setShowModal(false);
    };
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>Are you sure you want to update this company?</p>
                            </div>
