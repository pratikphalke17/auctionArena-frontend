...
const AllTeams = () => {
  ...
  return (
    <div className="container-fluid mt-0 p-5">
      <h1 className="text-center mb-4">User Dashboard <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-microsoft-teams" viewBox="0 0 16 16">
      ...
      <div className="row">
        <div className="col-lg-4 mb-4">
          <div className="card h-100">
            <div className="card-header bg-dark text-white text-center">Your Team</div>
                ...
                <>
                  ...
                  <ul className="list-group">
                    {userTeam.purchasedCompanies.map((company, index) => (
                      <li key={index} className="list-group-item bg-light text-dark"><img src={company.logo} style={{width:'110px',height:'50px'}}/></li>
                    ))}
                  </ul>
                </>
              ) : (
        ...
        <div className="col-lg-8">
          <div className="card h-100">
            <div className="card-header bg-dark text-white text-center">Other Teams</div>
            <div className="card-body bg-white text-dark">
                ...
                <tbody>
                  {otherTeams.map((team, index) => (
                    <tr key={index}>
                      ...
                      <td className="bg-light text-dark">{team.purchasedCompanies.map((company) => company.name).join(', ')}</td>
